...
def _apply_write_config():
    """从 reits-writing/write_config.json 读格式配置，覆盖本模块的格式变量。"""
    ...
    cfg_path = Path(__file__).resolve().parents[1] / "write_config.json"
